...
# s = "123456789"
# print(s.index("12"))
print(sorted([2, 12, 5, 11, 21, 16, 9, 14, 24, 13, 15, 27, 23, 17, 10, 25, 22, 19, 18, 3, 13, 4, 31, 29, 6, 8, 28, 1, 30, 7, 20, 26]))
print(len([2, 12, 5, 11, 21, 16, 9, 14, 24, 13, 15, 27, 23, 17, 10, 25, 22, 19, 18, 3, 13, 4, 31, 29, 6, 8, 28, 1, 30, 7, 20, 26]))